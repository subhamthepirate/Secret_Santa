...
class SecretSanta:
    ...
    def get_info(self):
        ...
        self.budget = int(input("Budget for Secret Santa"))
        for i in range(1, self.participants + 1):
            name = input("Name of participant {}?:".format(i))
            email = input("Enter email of participant {}?:".format(i))
            address = input("Enter address of participant {}?:".format(i))
            request = input("Enter request of participant {}?:".format(i))
